...
music = pygame.mixer.Sound("back_music.mp3")
music.play(-1)
...
Example1 = pygame.image.load("Example1.png")
Example2 = pygame.image.load("Example2.png")
...
bar = pygame.image.load("gamebar.png")
def bar_image(x):
...
while running:
    ...
    if ball1_y > 450 and ball1_y < 500 and math.sqrt(math.pow(ball1_x - bar_x,2)) < 36 and score_change1 == True:
        if ball2_move:
    ...
    if ball2_y > 450 and  ball2_y < 500 and math.sqrt(math.pow(ball2_x - bar_x,2)) < 32 and score_change2 == True:
        Tick.play()
